...
export function Sidebar({ mobileOpen, onMobileClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r border-gray-200 bg-white transition-transform dark:border-gray-700 dark:bg-gray-800 lg:translate-x-0",
      ...
      >
        <div className="flex h-16 items-center gap-3 border-b border-gray-200 px-6 dark:border-gray-700">
          ...
          <span className="text-lg font-bold text-gray-900 dark:text-gray-100">Motel Manager</span>
        </div>
